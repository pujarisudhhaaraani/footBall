...
import com.football.league.client.TeamStandingRestClient;
import com.football.league.dto.TeamStandingDto;
import com.football.league.exception.BadRequestException;
import com.football.league.log.annotation.Trace;
import com.football.league.log.eventtype.LogEventType;
import com.football.league.model.Country;
import com.football.league.model.Leagues;
import com.football.league.model.TeamStanding;
import com.football.league.model.TeamStandingRequest;
...
public class TeamStandingService {
  ...
  public TeamStandingDto getTeamStanding(TeamStandingRequest teamStandingRequest) {
    ...
    if (!isValidCountryResponse(teamStandingRequest, teamStandingDefault, country)) {
  ...
  private boolean isValidCountryResponse(TeamStandingRequest teamStandingRequest,
